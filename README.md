...
-   [Principaux établissements d’enseignement supérieur
    ...
    -   **Libellé** et **Sigle**
    -   **Groupe** : université, regroupement ou autre
    -   **Groupe détaillé** : type d’établissement tel qu’il apparaît
...
-   **Taux de titularité** : pourcentage d’enseignants titulaires parmis
    ...
    d’enseignants non titulaires « normale » [^2], ce n’est donc pas une
    mesure directe de la précarité enseignante.
...
-   Normalisés : les valeurs de la dernière année sont présentées en
    fonction de la moyenne nationale des établissements du même groupe ;
...
<img src="README_files/figure-gfm/etu.evol-1.png" width="100%" height="10%" style="display: block; margin: auto;" />
...
[^1]: les dépenses sont multiples, et un établissement peut très bien

...
wdesr_load_and_plot(wdid, c('composante_de', 'associé_de', 'membre_de'), depth=2, 
                      legend_position="right", arrow_gap = 0, margin_y = 0.1, label_sizes = c(2,4), label_wrap=10)
```
...
```{r, out.width = "100%", out.height=NULL, fig.width=10, fig.height=6, echo = FALSE, warning = FALSE}
wdesr_load_and_plot(wdid, c('composante','associé'), depth=2, label_sizes = c(2,4), label_wrap=10,
                      legend_position="right")
```

...
for (i in seq(1,nrow(etabs))) {
  ...
  cat("\\textit{\\scriptsize Pour participer à l'amélioration de ces graphiques, veuillez éditer ", wdurl," en suivant \\href{https://github.com/cpesr/wikidataESR/blob/master/Rmd/wikidataESR.md}{ce guide.}}")

...
etab_info <- function(etab) {
  list(
    ...
    dans.tdb = ifelse(etab$Comparable,"Oui","Non"),
    dans.evol = ifelse(etab$Comparable,"Oui","Non"),
    hors.norm = ifelse(etab$Comparable,"Oui","Non")
    )
...
#etabs <- esr.etab %>% arrange(Groupe,Etablissement) %>% filter(Plotable)

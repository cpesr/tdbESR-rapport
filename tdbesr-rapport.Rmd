...
cat_slide <- function(etab) {
  info <- etab_info(etab)
  cat(sep = '',"
  
\\etabheader[section]{",etab$Etablissement,"}{",
info$type,"}{",info$ratt,"}{",info$uai,"}{",
info$swurl,"}{",info$wdurl,"}{",info$lfurl,"}{",
"plot/",etab$UAI,"-kpi}"
)

  cat(sep = '',"
  
\\etabheader{",etab$Etablissement,"}{",
info$type,"}{",info$ratt,"}{",info$uai,"}{",
info$swurl,"}{",info$wdurl,"}{",info$lfurl,"}{",
"plot/",etab$UAI,"-series}"
)
...
etabs <- esr.etab %>% arrange(Groupe,Académie,Etablissement)
aca <- ""
groupe <- ""

...
Exemple de lecture : « Les données recensent 1,8 millions d'étudiants, dont 1,1 million en premier cycle (Licence) ».
...
plots$etu.evol+ sats + rm_ytext  + rm_ygrid + shrink_xtext + rl_margin
```

Exemple de lecture : « Les données recensent une augmentation de 19% de tous les étudiants, et de 24% en premier cycle (Licence) ».
